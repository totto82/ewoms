...
NEW_TYPE_TAG(Co2InjectionBaseProblem,INHERITS_FROM(StructuredGridVanguard));
...
// Set the grid type
SET_TYPE_PROP(Co2InjectionBaseProblem, Grid, Dune::PolyhedralGrid<2, 2>);
...
SET_STRING_PROP(Co2InjectionBaseProblem, SimulationName, "frisk2");
...
SET_SCALAR_PROP(Co2InjectionBaseProblem, DomainSizeX, 6.0);
SET_SCALAR_PROP(Co2InjectionBaseProblem, DomainSizeY, 4.0);
SET_SCALAR_PROP(Co2InjectionBaseProblem, DomainSizeZ, 1.0);

SET_INT_PROP(Co2InjectionBaseProblem, CellsX, 20);
SET_INT_PROP(Co2InjectionBaseProblem, CellsY, 20);
SET_INT_PROP(Co2InjectionBaseProblem, CellsZ, 10);
...
public:
                  ...
                  unsigned spaceIdx, unsigned timeIdx) const
    {
        ...
        if (onLeftBoundary_(pos)) {
            ...
            massRate[contiCO2EqIdx] = -1e+1; // [kg/(m^3 s)]
...
private:
    ...
    { return onRightBoundary_(pos) && (0.9 < pos[1]) && (pos[1] < 1.0); }
